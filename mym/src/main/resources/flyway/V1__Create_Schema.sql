...
(
    ...
    historical_product_historical_product_id BIGINT UNIQUE,
...
ALTER TABLE product
    ADD CONSTRAINT FK_PRODUCT_ON_HISTORICALPRODUCT_HISTORICALPRODUCTID FOREIGN KEY (historical_product_historical_product_id) REFERENCES historical_product (historical_product_id)
